...
// nombre, descripcion, atributo, multiplicador, multiplicador_efecto, tipo_poder, tipo_elemento, reutilizacion, duracion_efecto, objetivos, se_puede_usar, habilidades, daño_base
    ...
    {
        this.poderes[0] = new Poderes("golpe", "roger golpea al enemigo", "fuerza", 1f, 0f, "ataque", "tierra", 0, 0, "unico", true, new string[1]{"null"}, 10F, "congelar");
        ...
        this.poderes[2] = new Poderes("noquear", "roger noquea el objetivo", "fuerza", 1f, 0f, "ataque_debuff", "tierra", 5, 3, "unico", true, new string[1]{"aturdir"}, 10F, "congelar");
        this.poderes[3] = new Poderes("locura", "roger aumenta mucho su daño y baja su defensa", "fuerza", 0f, 10f, "buff", "tierra", 6, 3, "propio", true, new string[1]{"locura"}, 0F, "congelar");
